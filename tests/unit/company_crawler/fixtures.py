"""Shared fixtures for CompanyCrawlerProvider's tests — a fake, in-memory
...
def build_settings(**overrides: object) -> CompanyCrawlerProviderSettings:
    return CompanyCrawlerProviderSettings(**overrides)  # type: ignore[arg-type]
