...
Inflection Detection Engine's, Contact Verification Framework's, and
Executive Processing Pipeline's use cases, ports, and DTOs are
implemented — see `infrastructure/importers/README.md`, `cleaning/README.md`,
`identity_resolution/README.md`, `enrichment/README.md`,
`comparison/README.md`, `inflection/README.md`, `verification/README.md`,
and `executive_pipeline/README.md` for the full picture. `services/`
