...
Inflection Detection Engine's, and Contact Verification Framework's use
...
`comparison/README.md`, `inflection/README.md`, and
`verification/README.md` for the full picture. `services/` remains empty
on purpose; no other use cases exist yet.
