...
Enrichment Provider Framework's, and Executive Comparison Engine's use
cases, ports, and DTOs are implemented — see
`infrastructure/importers/README.md`, `cleaning/README.md`,
`identity_resolution/README.md`, `enrichment/README.md`, and
`comparison/README.md` for the full picture. `services/` remains empty on
